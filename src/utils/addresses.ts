...
// Important named addresses

export var addressMap = new Map<string, Address>()

function addEntry(label: string, address: string): void {
  addressMap.set(label, Address.fromString(address) as Address)
}

addEntry('NEWO', '0x98585dFc8d9e7D48F0b1aE47ce33332CF4237D96')
addEntry('SLP_TOKEN_ADDRESS', '0xc08ED9a9ABEAbcC53875787573DC32Eee5E43513')
addEntry('GNOSIS_SAFE_ADDRESS', '0x4a848F44146Ca6D1D6AA34bcdF3C41093deF1761')
addEntry('ONE_WAY_SWAP_ADDRESS', '0xb3c60348A8f8eD8B260FD1966c9f2b740e6caedF')

// Locked tokens addresses

var lockedTokensString = [
...
export var lockedTokens: Address[] = mapStringsToAddresses(lockedTokensString)

// Vesting contracts addresses

var vestingContractsString = [
...
export var vestingContracts: Address[] = mapStringsToAddresses(vestingContractsString)
